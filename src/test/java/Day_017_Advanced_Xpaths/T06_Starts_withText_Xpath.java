...
public class T06_Starts_withText_Xpath {
...
driver = TestBrowser.OpenChromeBrowser();
	  ...
	  // Start with Text()used for the Exact WebElement
	  ...
	  driver.findElement(By.xpath("//*[starts-with(text(),'Admin')]")).click();
	  driver.findElement(By.xpath("//*[starts-with(@id,'menu_admin_nationality')]")).click();
  }
